...
// Har bir rol uchun alohida JournalManagementPage komponentlarini import qilamiz
import JournalManagementPageForAdmin from './pages/admin/JournalManagementPage';
import JournalManagementPageForEditor from './pages/editor/JournalManagementPage'; // Bu faylni yaratganingizga ishonch hosil qiling
    ...
    <HashRouter>
      <Routes>
        ...
        >
          ...
          {/* Editor Routes */}
          {user?.role === UserRole.JOURNAL_MANAGER && (
            <>
              ...
              <Route path="journal-management" element={<JournalManagementPageForEditor />} /> 
          ...
          {user?.role === UserRole.ADMIN && (
            <>
              ...
              <Route path="journal-management" element={<JournalManagementPageForAdmin />} />
