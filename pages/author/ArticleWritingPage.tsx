    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold text-light-text">Maqola Yozish Xizmati</h1>
                <Button 
                    variant="secondary" 
                    onClick={() => navigate(-1)}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <Textarea
                            ...
                            placeholder="Maqola yozish uchun maxsus talablarni kiriting (betlar soni, maqola turi, va hokazo)"
                            rows={4}
                        />
                    </div>
